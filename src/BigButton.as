package 
{
	 ...
	 * @author	Adam Atomic
	 */
	public class BigButton extends FlxSprite
	{
		 ...
		 */
		public function BigButton(X:Number=0,Y:Number=0,Label:String=null,OnClick:Function=null)
		{
			super(X,Y);
			if(Label != null)
			{
				// CHANGE THE 120 to whatever the width of the button graphic is!!!!
				label = new FlxText(0,0,120,Label);
